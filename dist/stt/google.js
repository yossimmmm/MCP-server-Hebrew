    ...
    if (rawJson) {
        try {
            ...
            try {
                ...
                console.error("[STT] Invalid private_key in credentials, falling back to ADC:", e?.message || e);
                // ממשיך לפולבאק למטה
            }
            ...
            console.error("[STT] Failed to parse GOOGLE_CREDENTIALS_* JSON, falling back to ADC:", e?.message || e);
            // ניפול ל־ADC למטה
        }
    }
